define(['jquery'], function($){
	...
	var Simon = {
		...
		// Initializes game based on the mode the user chooses 
		init: function(){
			var that = this;
			
			// When user clicks start, the game begins
		...
		startGame: function(){
			...
			this.round = 0;
			this.active = true;
			$('[data-action="lose"]').hide();
			this.newRound();
		},
		
		
		// Add a new color to the sequence and animate it
		newRound: function(){
